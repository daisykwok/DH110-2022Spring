...
From this process, I learned about how important user feedback is, and that more often than not, people in real life may not interact with your designs in the way you intended or expected them to. One thing I  struggled with initially was trying to redesign SoundGym in a way that was actually unique and refreshing. When I was making my first wireframe and wireflow, I unconsciously stuck quite closely to the original design and layout of the website, incorporating small adjustments that I thought would work. This proved to be false, as the participant who tested the wireflow was still confused. For this project, taking the website into a mobile version forced me to reimagine the platform more creatively, and to reflect on how I would like certain features to be designed if I were also user.

Because I spent more time than expected rethinking how to design SoundGym, I was unable to flesh out some of its other features, such as the “Train”, “Profile”, and “Forum” tabs on the menu bar shown in the final prototype. In the future, I definitely would want to develop these features further. Due to time constraints, I also was not able to conduct as many cognitive walkthroughs of my high-fidelity prototype as I would have liked, and those that did participate did not provide any major feedback to work with. Additionally, another thing I would have done differently is to be more careful with the wireframing stage of the project. I sometimes connected the wireframes too quickly and would later realize I needed to add additional pages, which created  delays in the process as I had to reconfigure all the steps of the wireflow. 

In spite of these shortcomings, I am still quite satisfied with how my redesign of SoundGym turned out, and I think it does accomplish my overall intention of streamlining it to make easier to use and understand.
